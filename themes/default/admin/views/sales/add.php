...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        if (localStorage.getItem('remove_slls')) {
            ...
            if (localStorage.getItem('slremark')) {
                localStorage.removeItem('slremark');
            }
    ...
    ?>
        ...
        localStorage.setItem('slremark', '<?= str_replace(["\r", "\n"], '', $this->sma->decode_html($quote->remark)); ?>');
        ...
        if (!localStorage.getItem('slremark')) {
            localStorage.setItem('slremark', '<?=$slnumber?>');
        }
        if (!localStorage.getItem('sltax2')) {
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    echo form_input($warehouse_input);
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang('sale_remark', 'slremark'); ?>
                                            <?php echo form_input('sale_remark', ($_POST['sale_remark'] ?? $slnumber), 'class="form-control input-tip" id="slremark"'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
