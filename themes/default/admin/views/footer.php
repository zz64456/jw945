...
var lang = {uploaded: '<?=lang('uploaded');?>',not_uploaded: '<?=lang('not_uploaded');?>',paid: '<?=lang('paid');?>', pending: '<?=lang('pending');?>', completed: '<?=lang('completed');?>', ordered: '<?=lang('ordered');?>', received: '<?=lang('received');?>', partial: '<?=lang('partial');?>', sent: '<?=lang('sent');?>', r_u_sure: '<?=lang('r_u_sure');?>', due: '<?=lang('due');?>', returned: '<?=lang('returned');?>', transferring: '<?=lang('transferring');?>', active: '<?=lang('active');?>', inactive: '<?=lang('inactive');?>', unexpected_value: '<?=lang('unexpected_value');?>', select_above: '<?=lang('select_above');?>', download: '<?=lang('download');?>', required_invalid: '<?=lang('required_invalid');?>'};
</script>
<?php
...
<?= ($m == 'sales' && ($v == 'add' || $v == 'edit' || $v == 'salestmp' || $v == 'edit_tmp')) ? '<script type="text/javascript" src="' . $assets . 'js/sales.js"></script>' : ''; ?>
